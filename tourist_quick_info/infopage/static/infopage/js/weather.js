document.addEventListener('DOMContentLoaded', function() {
    ...
    curent_weather_divs.forEach(curent_weather_div => {
        ...
        update_weather(curent_weather_div);

    })
})


function refresh_weather(event) {
    let btn = event.target;
    let curent_weather_div = btn.previousElementSibling;
    update_weather(curent_weather_div);

}

function update_weather(curent_weather_div) {
    curent_weather_div.innerHTML = '';
